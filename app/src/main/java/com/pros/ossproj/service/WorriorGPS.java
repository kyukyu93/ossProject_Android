...
public class WorriorGPS extends Service implements LocationListener {
    ...
    public WorriorGPS(Context context) {
    ...
    public void stopUsingGPS(){
        if(locationManager != null){
            locationManager.removeUpdates(WorriorGPS.this);
        }
    }
    ...
    public void onStatusChanged(String provider, int status, Bundle extras) {
        // TODO Auto-generated method stub
        Log.e("onStatusChanged","onStatusChanged: " + provider + ", " + status);
    }
